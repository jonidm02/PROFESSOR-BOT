...
BOT_TOKEN = environ['BOT_TOKEN', '7221765393:AAH3arOL-huxSu3-IJHN_v_b9oIWaqV7qUI']
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002245139735'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002248071872')).split()]
